...
import { BookOpen, PlusCircle, LogOut, Menu, X } from "lucide-react";
      ...
      >
        ...
        <div className="p-4 border-t">
          <button
            ...
            className="flex items-center gap-2 text-red-500 hover:text-red-600 w-full border py-2 px-4 rounded-md"
          >
            <LogOut size={18} />
